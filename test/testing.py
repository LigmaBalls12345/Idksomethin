...
if(right>0 and wrong>0):
    print("Из данного списка {right} аккаунтов подходят ({right_l})\nА также {wrong} аккаунтов не подходят ({wrong_l})")
elif(right>0 and wrong==0):
    print("Из данного списка все аккаунты верны ({right_l})")
else:
    print("Из данного списка все аккаунт неверны ({wrong_l})")
